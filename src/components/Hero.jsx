...
const Hero = ({ searchQuery }) => {
        ...
        const fetchBooks = async() => {
            try {       
                ...
                const response = await fetch(`https://www.googleapis.com/books/v1/volumes?q=${encodeURIComponent(
                    searchQuery)}&maxResults=35&key=AIzaSyBwiXB80YQZMuJ6zuGKbW50Yp7AuhwRx2c`);
    ...
    if(allDummy) {
        return(
            <div className=' min-h-screen bg-gradient-to-b from-blue-970 via-blue-770 to-blue-950 p-8 flex justify-center
             items-center'>
                <p className=' text-cyan-300 text-lg md:text-xl text-center'>
                    No books were found matching your search.
                </p>
            </div>
        )
    }
    ...
    return (
        <div className=' min-h-screen pt-16 md:pt-20  bg-gradient-to-br from-gray-900 to-blue-900/30 p-4 sm:p-6 md:p-8'>
            <div className=' max-w-7xl mx-auto'>
                               ...
                               <a href={book.infoLink}
                                    ...
                                    aria-label={`View ${book.title}`} ></a>
                                        ...
                                        <div className=' mt-3 md:mt-6'>
                                            ...
                                            <p className=' text-gray-400 mt-1 md:mt2 text-sm md:text-base'>
                                                {book.authors}
                                            </p>
                                        ...
                                        <div className=' absolute inset-0 rounded-xl md:-2xl bg-gradient-to-br from-cyan-400/20 to blue-500/20
                ...
                <div className=' mt-6 md:mt-8 flex flex-wrap justify-center items-center gap-2 md:gap-3'>
                    ...
                    {generatePageNumber().map((page, index) => (
                      ...
                      <button onClick={() => setCurrentPage(p => Math.min(1, p+1))}
